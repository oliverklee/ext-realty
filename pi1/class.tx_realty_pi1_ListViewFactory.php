...
class tx_realty_pi1_ListViewFactory {
	...
	static public function make($type, array $conf, tslib_cObj $cObj) {
		switch ($type) {
			...
			default:
				throw new Exception(
					'The given list view type "' . $type . '" is invalid.'
				);
		}
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/realty/pi1/class.tx_realty_pi1_ListViewFactory.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/realty/pi1/class.tx_realty_pi1_ListViewFactory.php']);
}
?>