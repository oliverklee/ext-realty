...
class tx_realty_pi1_DescriptionView extends tx_realty_pi1_FrontEndView {
	 ...
	 *
	 * @return string HTML for the description view or an empty string if the
	 *                realty object with the provided UID has no title
	 */
	public function render(array $piVars = array()) {
		$this->setOrDeleteMarkerIfNotEmpty(
			'description',
			$this->pi_RTEcssText(tx_oelib_MapperRegistry
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/realty/pi1/class.tx_realty_pi1_DescriptionView.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/realty/pi1/class.tx_realty_pi1_DescriptionView.php']);
}
?>