...
### Added
- Add an announcement for the new crowdfunding campaign (#337)
- Add PHPStan to the CI builds (#320)
- Add an `.editorconfig` file (#304, #313)

### Changed
- Require oelib >= 3.6.4 for TYPO3 >= 8LTS (#309, #312, #319, #328)
...
### Changed
- Use PHP 7.2 for the TER release script (#284)
...
- Add a general "attachments" FAL field (#180)
...
### Fixed
- Avoid cHash warnings in the favorites list (#250)
