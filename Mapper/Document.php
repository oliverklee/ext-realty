...
* Copyright notice
*
* (c) 2010-2011 Bernd Schönbach <bernd.schoenbach@googlemail.com>
* All rights reserved
*
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/realty/Mapper/Document.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/realty/Mapper/Document.php']);
}
?>