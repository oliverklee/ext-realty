...
$TCA['tx_realty_objects'] = Array (
	...
	'columns' => Array (
		...
		'condition' => Array (
			'exclude' => 1,
			'label' => 'LLL:EXT:realty/locallang_db.xml:tx_realty_objects.condition',
			'config' => Array (
				'type' => 'select',
				'items' => Array (
					Array('', 0),
	...
	'types' => Array (
		'0' => Array('showitem' => 'sys_language_uid;;;;1-1-1, l18n_parent, l18n_diffsource, hidden;;1, object_number, object_type, title;;;;2-2-2, emphasized;;;;3-3-3, street, zip, city, district, number_of_rooms, living_area, total_area, rent_excluding_bills, extra_charges, heating_included, deposit, provision, usable_from, apartment_type, house_type, floor, floors, bedrooms, bathrooms, heating_type, garage_type, garage_rent, pets, construction_year, condition, balcony, garden, elevator, accessible, assisted_living, fitted_kitchen, description;;;richtext[cut|copy|paste|formatblock|textcolor|bold|italic|underline|left|center|right|orderedlist|unorderedlist|outdent|indent|link|table|image|line|chMode]:rte_transform[mode=ts_css|imgpath=uploads/tx_realty/rte/], equipment;;;richtext[cut|copy|paste|formatblock|textcolor|bold|italic|underline|left|center|right|orderedlist|unorderedlist|outdent|indent|link|table|image|line|chMode]:rte_transform[mode=ts_css|imgpath=uploads/tx_realty/rte/], layout, location;;;richtext[cut|copy|paste|formatblock|textcolor|bold|italic|underline|left|center|right|orderedlist|unorderedlist|outdent|indent|link|table|image|line|chMode]:rte_transform[mode=ts_css|imgpath=uploads/tx_realty/rte/], misc;;;richtext[cut|copy|paste|formatblock|textcolor|bold|italic|underline|left|center|right|orderedlist|unorderedlist|outdent|indent|link|table|image|line|chMode]:rte_transform[mode=ts_css|imgpath=uploads/tx_realty/rte/], images'),
		'1' => Array('showitem' => 'sys_language_uid;;;;1-1-1, l18n_parent, l18n_diffsource, hidden;;1, object_number, object_type, title;;;;2-2-2, emphasized;;;;3-3-3, street, zip, city, district, number_of_rooms, living_area, total_area, provision, usable_from, buying_price, year_rent, rented, apartment_type, house_type, floor, floors, bedrooms, bathrooms, heating_type, garage_type, garage_price, construction_year, condition, balcony, garden, elevator, accessible, fitted_kitchen, description;;;richtext[cut|copy|paste|formatblock|textcolor|bold|italic|underline|left|center|right|orderedlist|unorderedlist|outdent|indent|link|table|image|line|chMode]:rte_transform[mode=ts_css|imgpath=uploads/tx_realty/rte/], equipment;;;richtext[cut|copy|paste|formatblock|textcolor|bold|italic|underline|left|center|right|orderedlist|unorderedlist|outdent|indent|link|table|image|line|chMode]:rte_transform[mode=ts_css|imgpath=uploads/tx_realty/rte/], layout, location;;;richtext[cut|copy|paste|formatblock|textcolor|bold|italic|underline|left|center|right|orderedlist|unorderedlist|outdent|indent|link|table|image|line|chMode]:rte_transform[mode=ts_css|imgpath=uploads/tx_realty/rte/], misc;;;richtext[cut|copy|paste|formatblock|textcolor|bold|italic|underline|left|center|right|orderedlist|unorderedlist|outdent|indent|link|table|image|line|chMode]:rte_transform[mode=ts_css|imgpath=uploads/tx_realty/rte/], images')
	),
	'palettes' => Array (
