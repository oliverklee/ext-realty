...
CREATE TABLE tx_realty_objects (
	...
	energy_certificate_valid_until tinytext NOT NULL,
	energy_consumption_characteristic tinytext NOT NULL,
	with_hot_water int(1) unsigned DEFAULT '0' NOT NULL,
	ultimate_energy_demand tinytext NOT NULL,
	primary_energy_carrier tinytext NOT NULL,
	electric_power_consumption_characteristic tinytext NOT NULL,
	heat_energy_consumption_characteristic tinytext NOT NULL,
	value_category tinytext NOT NULL,
	year_of_construction tinytext NOT NULL,
	...
	energy_certificate_text tinytext NOT NULL,
	heat_energy_requirement_value tinytext NOT NULL,
	heat_energy_requirement_class tinytext NOT NULL,
	total_energy_efficiency_value tinytext NOT NULL,
	total_energy_efficiency_class tinytext NOT NULL,
